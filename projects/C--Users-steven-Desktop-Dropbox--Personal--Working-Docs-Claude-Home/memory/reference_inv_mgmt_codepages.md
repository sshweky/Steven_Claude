...
**CANONICAL PATH -- the ONLY correct location. Never use the Dropbox path or the steven user path. The correct user directory is StevenShweky(Fetch&B, not steven.**
