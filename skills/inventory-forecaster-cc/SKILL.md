...
|---|---|---|
| 2026-05-25 | F70 comment-based alert dismissal | Post-forecast pass: if most-recent active AI comment for a key starts with "reviewed" or "fyi" (case-insensitive), clear AI_ALERT before write-back. Uses the same `ai_comments` dict loaded by F58. Fires immediately after results loop, before alert count summary. |
