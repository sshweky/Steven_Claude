...
- **Phase 2 (master pack + Season from Styles)** -- QB direct REST API (`POST /v1/records/query` on `QB_STYLES_TABLE` = `bphzqfkev`). Batches WHERE-on-Mstyle in chunks of 500. FIDs: Mstyle=6, Master_Pack=110, Season=437.
