...
var COLS = [
  ...
  { id:'qty_oh_root', label:'Pcs OH (root)', align:'right', numeric:true,
    ...
    render:function(r){return '<td class="right">'+(r.is_multi?'<b>'+fmtInt(r.qty_oh_root)+'</b> <span style="color:#888;font-size:10px;">(+'+fmt(r.assembleable_kits)+')</span>':'<span style="color:#bbb;">&#8212;</span>')+'</td>';} },
