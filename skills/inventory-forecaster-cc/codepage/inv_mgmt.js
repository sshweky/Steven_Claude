...
var CACHE_KEY     = 'pp_inv_mgmt_v5';          // main (phase 1) IDB key -- v5: fixed Projections filter CT->SW
var CACHE_KEY_DTL = 'pp_inv_mgmt_dtl_v5';      // detail (phase 2) IDB key
var CACHE_KEY_SS  = 'pp_inv_mgmt_ss_v6';       // sessionStorage fast-path key
