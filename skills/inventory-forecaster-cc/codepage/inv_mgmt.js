...
var COLS = [
  ...
  { id:'mstyle', label:'Mstyle', align:'left',
    ...
    render:function(r){return '<td style="font-weight:700;color:#4169e1;">'+esc(r.mstyle)+(r.is_multi?' <span class="badge badge-purple" title="Multi-pack (kit)">KIT</span>':'')+'</td>';} },
  ...
  { id:'status_sub', label:'Status', align:'left',
    ...
    render:function(r){var s=esc(r.item_status_flow||r.item_status||'');return '<td style="display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;line-height:1.3;max-height:2.7em;">'+s+'</td>';} },
