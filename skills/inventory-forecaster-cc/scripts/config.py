...
QB_AMZ_CATALOG_TABLE   = os.environ.get("QB_AMZ_CATALOG_TABLE",   "bqp8vz625")  # InventoryTrack.Amazon_Catalog (Phase 2.5 legacy -- kept for reference)
QB_DAILY_METRICS_TABLE = os.environ.get("QB_DAILY_METRICS_TABLE", "brgxdpadi")  # Amazon AdTrack.Daily Metrics (Phase 2.5 replacement, 2026-05-28)
