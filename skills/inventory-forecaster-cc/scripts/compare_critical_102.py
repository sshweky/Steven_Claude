...
print(f"  {'Key':22s} {'Bucket':36s} {'Old AI':>9s} {'New AI':>9s} {'Manual':>9s} {'Δ old%':>8s} {'Δ new%':>8s} {'Saved':>9s}")
for r in per_key[:15]:
...
print(f"  {'Key':22s} {'Bucket':36s} {'Old AI':>9s} {'New AI':>9s} {'Manual':>9s} {'Δ old%':>8s} {'Δ new%':>8s} {'Cost':>9s}")
for r in per_key[:10]:
